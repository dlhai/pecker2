...
dict(table="base",title="表单显示类型",name="ftype",forder="",ftype="",twidth="",tstyle="",dtype="String(64)",drule="x",remark="none div input input_long textarea select pwd image",),
...
dict(table="user",title="标识",name="id",forder="",ftype="div",twidth="0.0",tstyle="",dtype="Integer,primary_key=True",drule="",remark="",),
dict(table="user",title="帐号",name="account",forder="",ftype="input",twidth="0.0",tstyle="",dtype="String(32)",drule="person.pinyin",remark="",),
dict(table="user",title="密码",name="pwd",forder="",ftype="pwd",twidth="0.0",tstyle="",dtype="String(32)",drule="person.pinyin",remark="",),
dict(table="user",title="头像",name="face",forder="",ftype="image",twidth="0.0",tstyle="",dtype="String(32)",drule="rnditem:_faceimage",remark="",),
dict(table="user",title="所在单位",name="depart_id",forder="",ftype="select",twidth="",tstyle="",dtype="Integer",drule="depart_id",remark="",),
...
dict(table="user",title="性别",name="sex",forder="",ftype="div",twidth="",tstyle="",dtype="String(8)",drule="id2sex(person.id)",remark="身份证住址信息",),
dict(table="user",title="民族",name="ethnic",forder="",ftype="select",twidth="0.0",tstyle="",dtype="String(16)",drule="rnditem:_ethnic",remark="",),
dict(table="user",title="出生年月",name="birth",forder="",ftype="div",twidth="0.0",tstyle="",dtype="String(16)",drule="id2birth(person.id)",remark="",),
