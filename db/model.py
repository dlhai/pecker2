...
def dict_winder(x,y):
    return dict(winderprov_id=y.id,winderco_id=y.winderco_id,name=x.name+"风场",addr=rnditem("_person").origin,scale=rnditem("_scale"),natural=rnditem("_songci"),fax=rnditem("_station").phone,remark=rnditem("_songci"),position=str(x.lng)+" "+str(x.lat))
...
dict(table="base",title="类型",name="type",type="image",ftype="",twidth="",tstyle="",dtype="String(64)",drule="x",remark="",),
dict(table="base",title="表单",name="ftype",type="",ftype="",twidth="",tstyle="",dtype="String(64)",drule="x",remark="",),
dict(table="base",title="表格宽度",name="twidth",type="",ftype="",twidth="",tstyle="",dtype="String(64)",drule="x",remark="",),
...
dict(table="user",title="姓名",name="name",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="person.name",remark="",),
dict(table="user",title="身份证号",name="idc",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="person.id",remark="",),
dict(table="user",title="性别",name="sex",type="",ftype="",twidth="",tstyle="",dtype="String(8)",drule="id2sex(person.id)",remark="身份证住址信息",),
dict(table="user",title="民族",name="ethnic",type="",ftype="",twidth="",tstyle="",dtype="String(16)",drule="rnditem:_ethnic",remark="",),
dict(table="user",title="出生年月",name="birth",type="",ftype="",twidth="",tstyle="",dtype="String(16)",drule="id2birth(person.id)",remark="",),
dict(table="user",title="籍贯",name="origin",type="",ftype="",twidth="",tstyle="",dtype="String(64)",drule="person.origin",remark="",),
dict(table="user",title="身份证扫描件",name="idimg",type="image",ftype="",twidth="",tstyle="",dtype="String(64)",drule='rndaddition("身份证")',remark="",),
dict(table="user",title="联系电话",name="phone",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="str(int(person.phone))",remark="",),
dict(table="user",title="QQ号码",name="qq",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="str(int(person.qq))",remark="",),
dict(table="user",title="邮箱",name="mail",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="mail",remark="",),
dict(table="user",title="微信号",name="wechat",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="rndwechat(person,mail)",remark="",),
dict(table="user",title="联系地址",name="addr",type="text",ftype="",twidth="",tstyle="",dtype="String(64)",drule="rnditem:_麦当劳门店:门店地址",remark="当前实际居住地址",),
dict(table="user",title="职位",name="job",type="",ftype="",twidth="",tstyle="",dtype="String(16)",drule="job",remark="专家、队长、技工、驻场、风场主管、调度、调度主管、仓管、仓管主管、设备司机、设备主管、公众",),
...
dict(table="leaf_vender",title="联系人",name="atten",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="p1.name",remark="",),
...
dict(table="efan_vender",title="联系人",name="atten",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="p1.name",remark="",),
...
dict(table="leaf",title="生产厂家",name="leaf_vender_id",type="",ftype="",twidth="",tstyle="",dtype="Integer,ForeignKey('leaf_vender.id')",drule="rnditem:leaf_vender:id",remark="",),
dict(table="leaf",title="主要材料",name="mat",type="",ftype="",twidth="",tstyle="",dtype="String(32)",drule="rnditem:_mainmat",remark="",),
dict(table="leaf",title="出厂时间",name="producedate",type="",ftype="",twidth="",tstyle="",dtype="Date",drule="pdt",remark="",),
dict(table="leaf",title="挂机时间",name="putondate",type="",ftype="",twidth="",tstyle="",dtype="Date",drule="rnddatespan(pdt,30,365)",remark="",),
])